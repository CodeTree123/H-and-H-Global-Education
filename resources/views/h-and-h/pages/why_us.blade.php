...
<link class="skin" rel="stylesheet" type="text/css" href="{{ asset('h-and-h/css/color/color-1.css') }}">

<!-- REVOLUTION SLIDER CSS ============================================= -->
<link rel="stylesheet" type="text/css" href="{{ asset('h-and-h/vendors/revolution/assets/css/layers.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('h-and-h/vendors/revolution/assets/css/settings.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('h-and-h/vendors/revolution/assets/css/navigation.css') }}">
	...
	<div class="page-wraper">
		<div id="loading-icon-bx"></div>
			...
			<div class="page-content bg-white">
				<!-- inner page banner -->
				<div class="page-banner ovbl-dark" style="background-image:url('https://www.shutterstock.com/image-photo/why-choose-us-businessman-holding-260nw-1431803342.jpg');">
					<div class="container">
				...
				<div class="content-block">
					...
					<!-- Our Services ==== -->
					<div class="section-area section-sp2 bg-fix ovbl-dark join-bx" style="background-image:url('https://t4.ftcdn.net/jpg/02/87/66/91/360_F_287669118_j5dQdApPRxoXuyXMrrGavM7uTydyh1AG.jpg');">
						<div class="container">
							<div class="row">
