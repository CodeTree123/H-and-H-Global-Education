    ...
    <div class="form-container">
        ...
        <div id="form1">
            ...
            <select class="form-control" id="course" name="course">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input type="text" class="form-control" id="Mode_of_study" name="mode_of_study" value="Enter Mode of study" placeholder="Enter Mode of study">
                    </div>
        ...
        <div id="form3" class="hidden">
            ...
            <div class="text-end">
                ...
                <button type="button" onclick="document.getElementById('studentForm').submit()" id="submitBtn" class="btn btn-success">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    inputs.forEach(input => {
        ...
        const label = input.previousElementSibling ? input.previousElementSibling.textContent.trim() : "Unknown Field";
